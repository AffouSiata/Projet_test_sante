      ...
      <div className="relative z-10 max-w-md w-full">
        ...
        <div className="mt-8 glass-effect p-6">
          <div className="flex items-center mb-3">
            ...
            <span className="font-semibold text-white">Demo Accounts</span>
          </div>
          <div className="space-y-2 text-sm text-white/90">
            <div className="flex justify-between p-2 bg-white/10 rounded">
              <span className="font-medium">Admin:</span>
              <span className="text-xs">admin@health.com / Admin@123</span>
            </div>
            <div className="flex justify-between p-2 bg-white/10 rounded">
              <span className="font-medium">Doctor:</span>
              <span className="text-xs">dr.smith@health.com / Doctor@123</span>
            </div>
            <div className="flex justify-between p-2 bg-white/10 rounded">
              <span className="font-medium">Patient:</span>
              <span className="text-xs">patient@example.com / Patient@123</span>
            </div>
          </div>
        </div>
      </div>
